export class CRUD{
    ...
    #tableNameValidate(tableName){
        if(tableName == undefined)throw new Error("Nombre de tabla requerido");
    }
    #save(){
    ...
    delete(id){
        this.#checkThatElementExistsWithId(id);
        this.#data.splice(id, 1); //this significa que mostrar
        this.#save();
        return true;
    }
}
